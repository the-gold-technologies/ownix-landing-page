          ...
          <div className="relative flex justify-center lg:justify-end z-10">
            <div className="relative w-full max-w-md aspect-[3/2] sm:aspect-[16/10] lg:aspect-[3/2] rounded-[2rem] bg-[#0a1a1a] shadow-2xl overflow-hidden group border border-[#2A8282]">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="text-sm font-bold text-white tracking-wide">Premium Asset Access</div>
                <div className="text-xs text-[#35ddb1] mt-1">High-yield fractional ownership</div>
              </div>
            </div>
          </div>
