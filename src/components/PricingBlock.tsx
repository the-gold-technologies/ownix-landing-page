...
export default function PricingBlock() {
  return (
    <section
      id="pricing"
      className="py-20 sm:py-28 relative z-10 overflow-hidden bg-gradient-to-b from-[#483418] via-[#755526] to-[#483418] text-white border-y border-[#825E2A]"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/20 border border-white/10 text-[10px] sm:text-xs font-bold uppercase tracking-[0.15em] text-[#F5C747] mb-6 shadow-sm">
              Pricing / Investment Information
            </div>

            <h3 className="text-4xl sm:text-[52px] font-black text-white tracking-tight mb-6 leading-none">
              Start Small. <span className="text-[#F5C747]">Grow Big.</span>
            </h3>
            ...
            <div>
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 px-8 py-3.5 rounded-2xl bg-gold-600 hover:bg-gold-700 text-white font-bold text-sm sm:text-base tracking-wide transition-all duration-300 shadow-lg shadow-gold-600/20 hover:scale-105 active:scale-95 group"
              >
          ...
          <div className="relative flex justify-center lg:justify-end z-10">
            <div className="relative w-full max-w-md aspect-[3/2] sm:aspect-[16/10] lg:aspect-[3/2] rounded-[2rem] bg-[#1A130A] shadow-2xl overflow-hidden group border border-[#825E2A]">
              <img
                src="/images/sustainable_luxury_tower.png"
                alt="Premium Property"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 ease-out"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#1A1204]/90 via-[#1A1204]/20 to-transparent pointer-events-none" />
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <div className="text-xs text-[#F5C747] mt-1">
